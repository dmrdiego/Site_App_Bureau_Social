  ...
  pt: {
    translation: {
      ...
      documents: {
        ...
        institutional: 'Documentos Institucionais',
      ...
      assemblies: {
        ...
        noAssembliesScheduled: 'Nenhuma assembleia agendada',
        futureAssemblies: 'As assembleias futuras aparecerão aqui',
        scheduled: 'Agendadas',
        inProgress: 'Em Curso',
        closed: 'Encerradas',
        dateTime: 'Data e Hora',
        location: 'Local',
        minimumQuorum: 'Quórum Mínimo',
        proxy: 'Procuração',
        proxyColon: 'Procuração:',
        manageProxy: 'Gerir Procuração',
        delegateVote: 'Delegue o seu voto nesta assembleia a outro associado',
        delegateVoteTo: 'Delegar voto a:',
        selectMember: 'Selecione um associado',
        proxyActive: 'Procuração ativa',
        delegatedTo: 'Delegou o voto a:',
        proxiesReceived: 'Procurações recebidas:',
        delegatedVoteToYou: 'delegou o voto em si',
        singleProxy: 'procuração',
        multipleProxies: 'procurações',
        creating: 'A criar...',
        createProxy: 'Criar Procuração',
        revokeProxy: 'Revogar Procuração',
        proxyCreated: 'Procuração criada',
        proxyCreatedSuccess: 'A sua procuração foi criada com sucesso',
        proxyRevoked: 'Procuração revogada',
        proxyRevokedSuccess: 'A sua procuração foi revogada com sucesso',
        errorCreatingProxy: 'Erro ao criar procuração',
        errorRevokingProxy: 'Erro ao revogar procuração',
        edit: 'Editar',
        startAssembly: 'Iniciar Assembleia',
        closeAssembly: 'Encerrar Assembleia',
        confirmPresence: 'Confirmar Presença',
        downloadMinutes: 'Download Ata',
        generating: 'A gerar...',
        generateMinutes: 'Gerar Ata',
        minutes: 'Ata',
        available: 'Disponível',
        minutesAvailable: 'Ata Disponível',
        minutesGeneratedSuccess: 'Ata gerada com sucesso',
        minutesGeneratedDescription: 'A ata foi gerada e está disponível para download',
        errorGeneratingMinutes: 'Erro ao gerar ata',
        errorGeneratingMinutesDescription: 'Ocorreu um erro ao gerar a ata',
        statusUpdated: 'Status atualizado',
        statusUpdatedSuccess: 'O status da assembleia foi atualizado com sucesso',
        errorUpdating: 'Erro ao atualizar',
        unauthorized: 'Não autorizado',
        redirectingToLogin: 'A redirecionar para login...',
        ordinary: 'Ordinária',
        extraordinary: 'Extraordinária',
        voteFoundersEffective: 'Voto: Fundadores e Efetivos',
        voteWithContributors: 'Voto: Fund., Efet. e Contrib.',
        voteWithVolunteers: 'Voto: Fund., Efet. e Volunt.',
        voteComplete: 'Voto: Todos (exceto Honorários)',
        voteFoundersOnly: 'Voto: Apenas Fundadores'
      },
      // Votações
      votes: {
        title: 'Votações',
  ...
  en: {
    translation: {
      ...
      assemblies: {
        ...
        noAssembliesScheduled: 'No assemblies scheduled',
        futureAssemblies: 'Future assemblies will appear here',
        scheduled: 'Scheduled',
        inProgress: 'In Progress',
        closed: 'Closed',
        dateTime: 'Date and Time',
        location: 'Location',
        minimumQuorum: 'Minimum Quorum',
        proxy: 'Proxy',
        proxyColon: 'Proxy:',
        manageProxy: 'Manage Proxy',
        delegateVote: 'Delegate your vote in this assembly to another member',
        delegateVoteTo: 'Delegate vote to:',
        selectMember: 'Select a member',
        proxyActive: 'Active proxy',
        delegatedTo: 'Delegated vote to:',
        proxiesReceived: 'Proxies received:',
        delegatedVoteToYou: 'delegated vote to you',
        singleProxy: 'proxy',
        multipleProxies: 'proxies',
        creating: 'Creating...',
        createProxy: 'Create Proxy',
        revokeProxy: 'Revoke Proxy',
        proxyCreated: 'Proxy created',
        proxyCreatedSuccess: 'Your proxy was created successfully',
        proxyRevoked: 'Proxy revoked',
        proxyRevokedSuccess: 'Your proxy was revoked successfully',
        errorCreatingProxy: 'Error creating proxy',
        errorRevokingProxy: 'Error revoking proxy',
        edit: 'Edit',
        startAssembly: 'Start Assembly',
        closeAssembly: 'Close Assembly',
        ...
        minutesGeneratedSuccess: 'Minutes generated successfully',
        minutesGeneratedDescription: 'The minutes were generated and are available for download',
        errorGeneratingMinutes: 'Error generating minutes',
        errorGeneratingMinutesDescription: 'An error occurred while generating the minutes',
        statusUpdated: 'Status updated',
        statusUpdatedSuccess: 'The assembly status was updated successfully',
        errorUpdating: 'Error updating',
        unauthorized: 'Unauthorized',
        redirectingToLogin: 'Redirecting to login...',
        ordinary: 'Ordinary',
        extraordinary: 'Extraordinary',
        voteFoundersEffective: 'Vote: Founders and Active Members',
        voteWithContributors: 'Vote: Found., Act. and Contrib.',
        voteWithVolunteers: 'Vote: Found., Act. and Volunt.',
        voteComplete: 'Vote: All (except Honorary)',
        voteFoundersOnly: 'Vote: Founders Only'
      },
      // Votações
      votes: {
        title: 'Votes',
